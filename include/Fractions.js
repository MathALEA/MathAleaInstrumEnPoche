...
class Fraction {
     ...
     */
        ...
        if (this.signe >= 0)
            this.texFractionSigneeParentheses = this.texFraction;
        else
            this.texFractionSigneeParentheses = '(' + this.texFractionSignee + ')';
        ...
        */
        this.fractionDecimale = function () {
            ...
            if (n5 == n2)
                ...
                return fraction(this.numIrred * 5 ** (n2 - n5), this.denIrred * 5 ** (n2 - n5));
        };
        ...
        this.representationIrred = function (x, y, rayon, depart = 0, type = 'gateau', couleur = 'gray', unite0 = 0, unite1 = 1, scale = 1, label = "") {
            ...
            if (type == 'gateau') {
                ...
                if (typeof (unite0) == 'number' && typeof (unite1) == 'number') {
                    ...
                    if (unite0 != "")
                        objets.push(texteParPosition(unite0, x, y - 0.6, 'milieu', 'black', scale));
                    if (unite1 != "")
                        objets.push(texteParPosition(unite1, x + rayon, y - 0.6, 'milieu', 'black', scale));
                    if (label != "")
                        objets.push(texteParPosition(label, x + rayon * this.numIrred / this.denIrred, y - 0.6, 'milieu', 'black', scale));
                }
            ...
            if (type == 'gateau') {
                ...
                if (typeof (unite0) == 'number' && typeof (unite1) == 'number') {
                    ...
                    if (unite1 != "")
                        objets.push(texteParPosition(unite1, x + rayon, y - 0.6, 'milieu', 'black', scale));
                    if (label != "")
                        objets.push(texteParPosition(label, x + rayon * this.num / this.den, y - 0.6, 'milieu', 'black', scale));
                }
            }
            else { //Type barre
                let diviseur;
